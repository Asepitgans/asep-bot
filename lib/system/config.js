const fs = require('fs')
const { Functions: Func, AlyaApi } = new (require('@moonr/func'))
global.Api = AlyaApi
global.header = `ᴀꜱᴇᴘɪᴛɢᴀɴꜱxᴄ - ʙᴏᴛꜱ v${require('../../package.json').version}`
global.footer = Func.Styles('simple whatsapp bot made by AsepitgansXc')
global.status = {
