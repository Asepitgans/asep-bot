module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = 'Â© AsepitganzXc - Bots'
      ...
      if (!('owners' in setting)) setting.owners = ['6289530656600']
      if (!('msg' in setting)) setting.msg = 'Hi +tag \nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\nâ—¦ *Database* : +db\nâ—¦ *Library* : Baileys\nâ—¦ *Website* : https://unitedcyberteam.com\nâ—¦ *Instagram* : develover_2003\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 1
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/a8a3392664fc5f5e0ec50.jpg'
      if (!('link' in setting)) setting.link = 'https://whatsapp.com/channel/0029VaAJF9Z9Bb66FgpP941s'
   } else {
      global.db.data.setting = {
         ...
         owners: ['6289530656600'],
         msg: 'Hi +tag \nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\nâ—¦ *Database* : +db\nâ—¦ *Library* : Baileys\nâ—¦ *Website* : https://unitedcyberteam.com\nâ—¦ *Instagram* : develover_2003\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 1,
         cover: 'https://telegra.ph/file/a8a3392664fc5f5e0ec50.jpg',
         link: 'https://whatsapp.com/channel/0029VaAJF9Z9Bb66FgpP941s'
      }
   }
}
